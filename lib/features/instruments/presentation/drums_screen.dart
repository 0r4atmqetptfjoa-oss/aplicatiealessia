import 'package:alesia/games/instruments/drums.dart';
...
class _State extends State<DrumsScreen> {
  ...
  void initState() {
    super.initState();
    game = DrumsGame();
    // TODO (Răzvan): Înlocuiește cu muzica de fundal finală pentru acest instrument: assets/audio/final/bg_drums_loop.mp3
    getIt<AudioService>().startAmbient('bg_drums_loop');
  }
      ...
      body: GameWidget(
        ...
        overlayBuilderMap: {
          ...
          'HintsHUD': (context, gameRef) {
            ...
            return HintsOverlay(stateListenable: (gameRef as DrumsGame).coachState, sticky: variant == 'on');
          },
        },
      ),
    );
