...
import 'package:alesia/features/settings/parental_settings_screen.dart';
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/parinte', builder: (context, state) => const ParentalSettingsScreen()),
    GoRoute(path: '/analitice', builder: (context, state) => const AnalyticsScreen()),
